...
export default function SalesSection() {
  ...
  return (
    <div className="p-4 md:p-6 space-y-6">
      <div>
        <h2 className="text-lg font-bold text-[#F1F5F9]">Ανάλυση Πωλήσεων</h2>
        <p className="text-sm text-[#94A3B8]">Μαρ 2024 – Φεβ 2026 · {totalOrders} παραγγελίες · €{totalRevenue.toLocaleString("el-GR", { minimumFractionDigits: 0 })} έσοδα</p>
      </div>

      {/* Full-width trend chart with toggle */}
      <div className="rounded-xl border border-[#2A2D3A] bg-[#1A1D27] p-4">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-sm font-semibold text-[#94A3B8] uppercase tracking-wide">Τάση Πωλήσεων</h3>
          <div className="flex gap-1 bg-[#1A1D27] rounded-lg p-0.5">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
        <div className="rounded-xl border border-[#2A2D3A] bg-[#1A1D27] p-4">
          <h3 className="text-sm font-semibold text-[#94A3B8] mb-4 uppercase tracking-wide">Έσοδα ανά Μήνα</h3>
          <MonthlyRevenueBar data={monthlyTrend} height={220} />
        </div>

        <div className="rounded-xl border border-[#2A2D3A] bg-[#1A1D27] p-4">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-sm font-semibold text-[#94A3B8] uppercase tracking-wide">Top Προϊόντα</h3>
            <div className="flex gap-1 bg-[#1A1D27] rounded-lg p-0.5">
              {(["revenue", "units"] as const).map(m => (
                <button
                  ...
                  className={`px-3 py-1 rounded-md text-xs font-medium transition-colors ${
                    topMetric === m ? "bg-[#f97316] text-white" : "text-[#475569] hover:text-[#aaa]"
                  }`}
                >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="rounded-xl border border-[#2A2D3A] bg-[#1A1D27] p-4">
          <h3 className="text-sm font-semibold text-[#94A3B8] mb-2 uppercase tracking-wide">Brands</h3>
          <BrandPieChart data={brands} height={220} />
        </div>

        <div className="rounded-xl border border-[#2A2D3A] bg-[#1A1D27] p-4">
          <h3 className="text-sm font-semibold text-[#94A3B8] mb-4 uppercase tracking-wide">Κανάλι Πωλήσεων</h3>
              ...
              return (
                <div key={ch.channel}>
                  <div className="flex justify-between text-xs mb-1">
                    ...
                    <span className="text-[#475569]">{pct.toFixed(0)}% · {ch.orders} παραγγ.</span>
                  </div>
          ...
          <div className="mt-4 pt-4 border-t border-[#1e1e1e]">
            <div className="text-xs text-[#475569] mb-2">Τύπος Πελάτη</div>
            <div className="flex gap-2">
              <div className="flex-1 text-center py-2 rounded-lg bg-orange-500/10">
                ...
                <div className="text-[#475569] text-xs">Λιανική</div>
              </div>
              <div className="flex-1 text-center py-2 rounded-lg bg-blue-500/10">
                ...
                <div className="text-[#475569] text-xs">Χονδρική</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-xl border border-[#2A2D3A] bg-[#1A1D27] p-4">
          <h3 className="text-sm font-semibold text-[#94A3B8] mb-4 uppercase tracking-wide">Top Πελάτες</h3>
